            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group row"><label for="firstname" class="col-2 col-form-label">Name</label>
                        <div class="col-10">
                            <form:input type="text" class="form-control" id="firstname" path="firstName"
                                        name="first-name-textfield" placeholder="firstName"></form:input>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-10">
                            <form:input type="text" class="form-control" path="lastName" name="last-name-textfield"
                    ...
                    <div class="form-group row">
                        <label for="specialization" class="col-2 col-form-label">Specialization</label>
                        <div class="col-10">
                            <form:select path="specialization.specializationName" id="specialization" name="specialization"
                                         class="form-control" placeholder="specialization" title="">
